...
export function ApprovalPage() {
  ...
  const handleRequestChanges = () => {
    ...
    setModalConfig({
      ...
      message: 'Are you sure you want to request changes to this payment request?',
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex items-center mb-6">
        <Link to={`/payment-requests/${id}`} className="btn btn-ghost btn-sm mr-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="card bg-base-100 shadow-xl mb-6">
            <div className="card-body">
              <h3 className="text-lg font-bold mb-4">Payment Request Details</h3>
          ...
          <div className="card bg-base-100 shadow-xl sticky top-4">
            <div className="card-body">
              ...
              <div className="form-control">
                ...
                <label className="label">
                  <span className="label-text-alt text-error">
                    {!comment.trim() && 'Comments are required before taking any action'}
                  </span>
                </label>
              </div>
              ...
              <div className="space-y-4 mt-4">
                ...
                <Link to={`/payment-requests/${id}`} className="btn btn-outline w-full">
                  Cancel
                </Link>
              </div>
            </div>
