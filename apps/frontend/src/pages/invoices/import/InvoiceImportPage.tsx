      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          <ul className="steps steps-horizontal w-full mb-8">
            <li className={`step ${step === 'upload' || step === 'validate' || step === 'confirm' ? 'step-primary' : ''}`}>Upload File</li>
            <li className={`step ${step === 'validate' || step === 'confirm' ? 'step-primary' : ''}`}>Validate</li>
            <li className={`step ${step === 'confirm' ? 'step-primary' : ''}`}>Confirm</li>
          </ul>
          
          {step === 'upload' && (
            <div className="space-y-6">
              <div className="flex flex-col items-center justify-center border-2 border-dashed border-base-300 rounded-lg p-12">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-base-300 mb-4" viewBox="0 0 20 20" fill="currentColor">
                ...
                {file && (
                  <div className="mt-4 text-center">
                    ...
                    <p className="text-sm text-base-content/70">{(file.size / 1024).toFixed(2)} KB</p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-4">
                <div className="form-control">
                  <label className="label cursor-pointer justify-start">
                    ...
                    />
                    <span className="label-text ml-2">Skip duplicate invoices</span>
                  </label>
                </div>
                ...
                <div className="form-control">
                  <label className="label cursor-pointer justify-start">
                    ...
                    />
                    <span className="label-text ml-2">Override existing invoices</span>
                  </label>
                </div>
                ...
                <div className="form-control">
                  <label className="label cursor-pointer justify-start">
                    ...
                    />
                    <span className="label-text ml-2">Validate only (no import)</span>
                  </label>
                </div>
              </div>
              ...
              <div className="flex justify-end gap-2 mt-6">
                ...
                >
                  {isImporting ? (
                    ...
                    importOptions.validateOnly ? 'Done' : 'Import'
                  )}
                </button>
              </div>
            </div>
          ...
          {step === 'confirm' && (
            <div className="text-center py-8">
              <div className="flex justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24 text-success" viewBox="0 0 20 20" fill="currentColor">
              ...
              <p className="text-lg mb-8">
                {validCount + warningCount} invoices have been successfully imported.
              </p>
