...
export function InvoiceDetailPage() {
  ...
  const [linkedPaymentRequests, setLinkedPaymentRequests] = useState<PaymentRequest[]>([]);
      ...
      <div className="container mx-auto p-4">
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <p>The invoice you are looking for does not exist or has been removed.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <div className="mb-4">
                    <label className="text-sm font-medium opacity-70">Vendor</label>
                    {isEditing ? (
                      <input
                        type="text"
                  ...
                  <div className="mb-4">
                    <label className="text-sm font-medium opacity-70">Invoice Date</label>
                    {isEditing ? (
                      <input
                        type="date"
                        className="input input-bordered w-full mt-1"
                  ...
                  <div className="mb-4">
                    <label className="text-sm font-medium opacity-70">Due Date</label>
                    {isEditing ? (
                      <input
                        type="date"
                        className="input input-bordered w-full mt-1"
                ...
                <div>
                  ...
                  <div className="mb-4">
                    <label className="text-sm font-medium opacity-70">PO Number</label>
                    {isEditing ? (
                      <input
                        type="text"
                        className="input input-bordered w-full mt-1"
                  ...
                  <div className="mb-4">
                    ...
                    {isEditing ? (
                      ...
                      <p className="font-medium">{invoice.notes || 'No notes'}</p>
                    )}
                  </div>
                </div>
              </div>
          ...
          <div className="card bg-base-100 shadow-xl mt-6">
            <div className="card-body">
              <h2 className="card-title text-xl mb-4">Linked Payment Requests</h2>
              ...
              <div className="card-actions justify-end mt-4">
                <Link to={`/payment-requests/create?invoiceId=${invoice.id}`} className="btn btn-primary">
        ...
        <div>
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <div className="mb-4">
                <label className="text-sm font-medium opacity-70">Contact Name</label>
                {isEditing ? (
                  <input
                    type="text"
                    className="input input-bordered w-full mt-1"
          ...
          <div className="card bg-base-100 shadow-xl mt-6">
            <div className="card-body">
              ...
              <div className="bg-base-200 rounded-lg p-4 flex flex-col items-center justify-center h-64">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 text-base-content opacity-50 mb-4" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd" />
                </svg>
                <p className="text-center">Invoice document preview</p>
                <button className="btn btn-sm btn-outline mt-4">View Full Document</button>
              </div>
            </div>
          </div>
        </div>
      ...
      {showConfirmDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="modal-box">
            ...
            <p className="py-4">Are you sure you want to mark this invoice as obsolete? This action cannot be undone.</p>
            <div className="modal-action">
              <button className="btn btn-outline" onClick={cancelMarkObsolete}>Cancel</button>
              <button className="btn btn-error" onClick={confirmMarkObsolete}>Mark as Obsolete</button>
            </div>
          </div>
        </div>
      )}
