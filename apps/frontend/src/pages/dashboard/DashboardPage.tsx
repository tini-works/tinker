        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <div className="grid grid-cols-1 gap-3">
              <Link to="/invoices/import" className="btn btn-primary btn-block justify-start">
              ...
              <Link to="/payment-requests/create" className="btn btn-secondary btn-block justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
              ...
              <Link to="/payment-requests/approvals" className="btn btn-accent btn-block justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
              ...
              <Link to="/invoices" className="btn btn-neutral btn-block justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
              ...
              <Link to="/payment-requests" className="btn btn-neutral btn-block justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="card-body">
            ...
            <div className="space-y-3">
              <div className="alert alert-warning">
                ...
                <Link to="/payment-requests/125" className="btn btn-sm">View</Link>
              </div>
              ...
              <div className="alert alert-info">
                ...
                <Link to="/payment-requests/124" className="btn btn-sm">View</Link>
              </div>
              ...
              <div className="alert alert-success">
                ...
                <div>
                  <h3 className="font-bold">Invoice Batch Successfully Imported</h3>
                  <div className="text-xs">5 hours ago</div>
                </div>
                <Link to="/invoices" className="btn btn-sm">View</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card-body">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-sm opacity-70">Role: Admin | Last Login: Today, 09:45 AM</p>
            </div>
