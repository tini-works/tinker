...
export async function seedDatabase() {
  ...
  try {
    ...
    const seedPaymentRequests = await db.insert(paymentRequests).values([
      {
        id: 'pr-001',
        totalAmount: 2100.50,
    ...
    console.log(`✅ Created ${seedPaymentRequests.length} payment requests`);

    // Link invoices to payment requests
    console.log('Linking invoices to payment requests...');
    ...
    console.log('✅ Linked invoices to payment requests');
    ...
    console.log('✅ Created approval history entries');

    // Seed Business Process Logs
    console.log('Seeding business process logs...');
    ...
    console.log('✅ Created business process log entries');
    ...
    console.log(`   Invoices: ${stats.invoices.length}`);
    console.log(`   Payment Requests: ${stats.paymentRequests.length}`);
    console.log(`   Approval History: ${stats.approvalHistory.length}`);
    console.log(`   Business Process Logs: ${stats.businessProcessLogs.length}`);
